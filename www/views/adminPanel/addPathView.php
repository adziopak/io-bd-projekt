...
class addPathView
{
	...
	function render()
	{
		...
		$css = file_get_contents('views/adminPanel/addPathView.css');
		$body = file_get_contents('views/adminPanel/addPathView.html');
		$js = file_get_contents('views/adminPanel/addPathView.js');
